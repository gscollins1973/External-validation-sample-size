...
lines(OUT[c(1, 6, 11, 16, 21, 26, 31, 36, 41, 46, 51) + 1, 3], OUT[c(1, 6, 11, 16, 21, 26, 31, 36, 41, 46, 51) + 1, 5], type = 'b', col = 2, cex = 0.5)
lines(OUT[c(1, 6, 11, 16, 21, 26, 31, 36, 41, 46, 51) + 2, 3], OUT[c(1, 6, 11, 16, 21, 26, 31, 36, 41, 46, 51) + 2, 5], type = 'b', col = 3, cex = 0.5)
lines(OUT[c(1, 6, 11, 16, 21, 26, 31, 36, 41, 46, 51) + 3, 3], OUT[c(1, 6, 11, 16, 21, 26, 31, 36, 41, 46, 51) + 3, 5], type = 'b', col = 4, cex = 0.5)
lines(OUT[c(1, 6, 11, 16, 21, 26, 31, 36, 41, 46, 51) + 4, 3], OUT[c(1, 6, 11, 16, 21, 26, 31, 36, 41, 46, 51) + 4, 5], type = 'b', col = 5, cex = 0.5)
grid()
...
axis(side = 1, at = E[-1], cex.axis=0.75)
lines(OUT[c(1, 6, 11, 16, 21, 26, 31, 36, 41, 46, 51) + 1, 3], OUT[c(1, 6, 11, 16, 21, 26, 31, 36, 41, 46, 51) + 1, 7], type = 'b', col = 2, cex = 0.5)
lines(OUT[c(1, 6, 11, 16, 21, 26, 31, 36, 41, 46, 51) + 2, 3], OUT[c(1, 6, 11, 16, 21, 26, 31, 36, 41, 46, 51) + 2, 7], type = 'b', col = 3, cex = 0.5)
lines(OUT[c(1, 6, 11, 16, 21, 26, 31, 36, 41, 46, 51) + 3, 3], OUT[c(1, 6, 11, 16, 21, 26, 31, 36, 41, 46, 51) + 3, 7], type = 'b', col = 4, cex = 0.5)
lines(OUT[c(1, 6, 11, 16, 21, 26, 31, 36, 41, 46, 51) + 4, 3], OUT[c(1, 6, 11, 16, 21, 26, 31, 36, 41, 46, 51) + 4, 7], type = 'b', col = 5, cex = 0.5)
grid()
legend("topright", col = 1:6, legend = as.character(sd.v), lty = 1, title = expression(paste('SD(LP) ', sigma)), cex = 0.75)
abline(v = 100, lty = 2)
abline(v = 200, lty = 2)
